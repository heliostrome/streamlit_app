...
def get_path():
    path = Path(__file__).parent / "../Add_solar_pumping_system_files/solar_module_files/CEC Modules.csv"
        
    #path = "F:/OneDrive/Personal/Heliostrome/UI/Frontend/pages/Add_solar_pumping_system_files/solar_module_files/CEC Modules.csv"
