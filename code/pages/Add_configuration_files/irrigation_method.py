...
def select_irrigation_method():
    ...
    if option == "Drip irrigation":
        ...
        with st.sidebar.container():
            path_drip_basic_image = Path(__file__).parent / "../Add_configuration_files/irrigation_method_files/pics/Drip layout basic.png"
        ...
        with col4:
            path_dripper_image = Path(__file__).parent / "../Add_configuration_files/irrigation_method_files/pics/Drip layout.png"
        ...
        with col4:
            path_drip_cs_image = Path(__file__).parent / "../Add_configuration_files/irrigation_method_files/pics/Drip cross section.png"
